...
# Uploads ko static ke andar ek specific sub-folder mein rakhein
UPLOAD_BASE = os.path.join(STATIC_DIR, 'uploads')

# Specific folders for different types of uploads
UPLOAD_FOLDER = os.path.join(UPLOAD_BASE, 'id_docs')    # User photos/IDs
KNOWLEDGE_FOLDER = os.path.join(UPLOAD_BASE, 'ai_docs') # AI Training Files
NOTES_FOLDER = os.path.join(UPLOAD_BASE, 'notes')      # Study material

# Ensure all directories exist
for folder in [UPLOAD_FOLDER, KNOWLEDGE_FOLDER, NOTES_FOLDER]:
    if not os.path.exists(folder):
        os.makedirs(folder)
...
@app.route('/') 
def home():
    return render_template('coefront.html')

@app.route('/login_page')
def show_login():
    return render_template('login.html')

@app.route('/register_page') # Naam thoda alag rakha hai taaki conflict na ho
def show_register():
    return render_template('register.html')

@app.route('/chatbot_page')
def show_chabot_page():
...
@app.route('/admin_ai_docs_page')
def admin_ai_docs_page():
    return render_template('admin_ai_docs.html') 

@app.route('/admin_marks_page')
def admin_marks_page():
    return render_template('admin_marks.html') 

@app.route('/admin_notes_page')
def admin_notes_page():
    return render_template('admin_notes.html') 

@app.route('/admin_timetable_page')
def admin_timetable_page():
    return render_template('admin_timetable.html') 

@app.route('/admin_student_varification_page')
def admin_student_varification_page():
    return render_template('student_verification.html') 

@app.route('/admin_varified_students_page')
def admin_varified_students_page():
    return render_template('varified_students.html')

# app.py mein ye check karein
@app.route('/dashboard_page') # Ye URL browser/JS call karega
def dashboard_navigation():   # Function ka naam unique rakhein
...
@app.route('/getid_page')
def getid_page():
    return render_template('getid.html')

@app.route('/id_card_apply_page')
def id_card_apply_page():
